...
<body onload="updateClock()">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-black">
    <div class="container">
      ...
      <img src="<?= base_url('img/logogg.png'); ?>" alt="Logo" class="custom-image me-2" >
      <a class="navbar-brand gaprint" href="/dashboard">Granito.id</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <!-- KARYAWAN -- HASYIM, HAFIDZ, DKK  -->
          <?php if (session()->get('jabatan') == 'karyawan') : ?>
            <li class="nav-item">
          <?php endif; ?>
          ...
          <?php if (session()->get('jabatan') == 'bos') : ?>
            <li class="nav-item">
              <a class="nav-link" href="/bos/tampil">User</a>
            </li>
          <?php endif; ?>
          <?php if (session()->get('jabatan') == 'bos') : ?>
            <li class="nav-item">
